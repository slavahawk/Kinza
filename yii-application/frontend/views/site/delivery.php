...
?>
    ...
    <main>
        <section class="delivery">
            <div class="delivery__content" style="margin-top: 140px">
<!--                <h1>Доставка</h1>-->
                <div class="delivery__content__item" style="color:#000; text-align:center;">
                    <h2 style="font-size: 48px; font-weight: 700; margin-bottom: 20px; color:#fc4a02;">Минимальная сумма заказа 400р</h2>
                    ...
                    <h2 style="font-size: 48px; font-weight: 700; margin-bottom: 20px; color:#fc4a02;">В удаленные районы города заказ от 1000р</h2>
